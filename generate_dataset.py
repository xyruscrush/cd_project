...
def generate_sample():
    ...
    if is_unused == 1 and contains_sensitive == 1:
        label = 2  
    elif is_unused == 1 and days_since_last_edit > 180:
        label = 1 
    else:
        label = 0  
    ...
    return [
        ...
        days_since_last_edit,author_count,
        recent_modification,label
    ]
...
df.to_csv("../datasets/dead_code_dataset.csv", index=False)
